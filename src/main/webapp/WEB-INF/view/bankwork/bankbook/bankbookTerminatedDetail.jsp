	...
	<div id="container">
		...
		<form>
			<div id="profile">
				...
				<div id="submit">
					<input type="submit" value="삭제" id="del" formaction="${pageContext.request.contextPath}/bankwork/bankbook/terminatedDetail.do?cmd=del&accountNum=${bankbook.accountNum}&custName=${bankbook.custCode.custName}" formmethod="post">
