...
/* 		//get에서 부서별로 사원들의 마지막 값을 받아옴 
		...
		$("form").submit(
				...
				function() {
					...
					let empCode = $("input[name='empCode']").val();
					let empName = $("input[name='empName']").val();
					let empTitle = $("input[name='empTitle']").val();
					...
					let empPwd = $("input[name='empPwd']").val();
...
<body>
	<div id="container">
		...
		<form action="/emp/empUpdate.do" method="post" enctype="multipart/form-data">
